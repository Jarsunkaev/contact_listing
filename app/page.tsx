    ...
    <div className="min-h-screen bg-[#141414] relative">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="h-full max-w-[720px] mx-auto relative">
          <div className="absolute top-0 bottom-0 left-0 w-px bg-[#282828]"></div>
          <div className="absolute top-0 bottom-0 right-0 w-px bg-[#282828]"></div>
        </div>
        <div className="absolute top-20 left-0 right-0 h-px bg-[#282828]"></div>
      </div>
